...
public class TestListener implements WebDriverListener {
	...
	public void afterFindElement(WebDriver driver, By locator, WebElement result) {
		Reporter.log("DONE: element found for locator " + locator,true);
	...
	public void afterForward(Navigation navigation) {
		Reporter.log("DONE: Browser navigated ",true);
		// TODO Auto-generated method stub
	...
	public void afterFullscreen(Window window) {
		Reporter.log("DONE: browser is maximized",true);
	...
	public void afterGet(WebDriver driver, String url) {
		// TODO Auto-generated method stub
		Reporter.log("DONE: Navigating to url " + url,true);
	...
	public void beforeFindElement(WebDriver driver, By locator) {
		Reporter.log("finding element for " + locator,true);
