...
import selenium.test.SwitchToTest_Frames;

public class TestListener2 implements WebDriverListener {
	...
	public void afterFindElement(WebDriver driver, By locator, WebElement element) {
		System.out.println("DONE: element found for locator " + locator);
	...
	public void afterForward(Navigation navigation) {
		System.out.println("DONE: Browser navigated ");
		// TODO Auto-generated method stub
	...
	public void afterFullscreen(Window window) {
		System.out.println("DONE: browser is maximized");
	...
	public void afterGet(WebDriver driver, String url) {
		// TODO Auto-generated method stub
		System.out.println("DONE: Navigating to url " + url);
	...
	public void beforeClick(WebElement element) {
		...
		WebDriverWait wait=new WebDriverWait(SwitchToTest_Frames.driver, duration);
	...
	public void beforeFindElement(WebDriver driver, By locator) {
		System.out.println("finding element for " + locator);
